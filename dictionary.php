            ...
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    if ($_SESSION['user_type']==="Student") 
                    {
                        ...
                        <li class="nav-item"><a class="nav-link active" href="dictionary.php"><i class="fa fa-book"></i><span>Dictionary Lookup</span></a></li>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">English Dictionary</h3>
                    ...
                    <div class="row">
                        <div class="col-md-7 mb-4">
                            <div class="card h-100"><a href="#"></a>
                                <h4 style="margin-right: 0px;margin-left: 20px;margin-top: 8px;">Search Meanings and Synonyms</h4>
                                <div class="row">
                                    <div class="col"></div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-5 mb-4">
                            <div class="card border-white h-100">
                                <div class="card-body">
                                    <h4 class="card-title">Search for Rhymes</h4>
                                    <div class="col"></div>
                                </div>
                            </div>
                        </div>
