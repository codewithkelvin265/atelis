...
function fail() {
  ...
  //sug4r
  element2.appendChild(text);
  element2.appendChild(tryagain);
  element2.appendChild(div);
  element2.appendChild(next);
