            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div  style="background-color: #263238;" class="card shadow mb-5">
                        <center>
                            <h2 style="color: #FF9800;">Second Step: Sing Higher</h2>
  
                            <p>Sing from your base note to the top of your vocal range.</p>
                            <button style="font-size: 30px;" id="recordbutton">Record</button>
                            <button style="font-size: 30px;" id="play">Play Note</button>
                            <br>
                            <br>
                            <div id="vrcont" style="font-size: 30px;"></div>
                            <br>
                            <br>
                        </center>
                        <br>
