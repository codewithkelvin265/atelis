        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: rgb(25,34,58);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../vocalranger/index.php"><i class="fas fa-table"></i>Vocal Ranger</a></li>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                    ...
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle me-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        ...
                        <ul class="navbar-nav flex-nowrap ms-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="d-none d-lg-inline me-2 text-gray-600 small"><strong></strong></span><img class="border rounded-circle img-profile" src="../assets/img/user.png"></a>
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Vocal Ranger</h3>
                    <div style="background-color: #263238; justify-content: center;" class="card shadow mb-5">
                        <center>
                            <h2 style="color: #FF9800;">Your Vocal Range Results</h2>
                            <br>
                            <div id="vrcont" style="font-size: 30px;">
                                <p>Your Vocal Range is...</p>
                            </div>
                            <br>
                            <table style="width: 80%; ">
                              <tbody><tr>
                                <th style="font-size: 30px;">Female Voice Types</th>
                                <th style="font-size: 30px;">Male Voice Types</th>
                              </tr>
                              <tr>
                                <td>Soprano (C4-C6)</td>
                            ...
                            <br>
                            <br>
                            <img style="width: 100%;" src="../assets/img/range.png">
                            <br>
                            <br>
                            <br>
                            <button style="font-size: 30px;" onclick="location.href = 'index.php'">Restart</button>
