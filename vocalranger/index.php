        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div style="background-color: #263238;" class="card shadow mb-5">
                        <center>
                        <h1 style="color: #FF9800;">Vocal Range Detector</h1>
                        <p id="determine">Determine your vocal range.</p>
                        
                        <div style="font-size: 20px; color: #EFEFF3;" id="steps">
                          <p style="font-size: 30px;"><u>Steps</u></p>
                          <ol>
                            <li>Base Note</li>
                              <ul>
                        ...
                        <button style="font-size: 30px; color: white; background-color: #1D62F0;" class="btn btn-secondary btn-lg d-none d-xl-inline-block" id="begin" onclick="location.href = 'first-step.php'">Begin!</button>
                        <br>
                        </center>
                    </div>
                </div>
