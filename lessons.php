        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4"><?php echo $_GET["sc"]." ";?>Lessons</h3>
                </div><!-- Start: Back-Next Nav -->
                <div><a class="btn btn-outline-primary" role="button" href="courses.php">← Back</a><a class="btn btn-outline-primary float-end" role="button" href="#">Continue →</a></div><!-- End: Back-Next Nav -->
                <!-- Start: Card Info -->
                <div class="card shadow border-start-info py-2" style="width: 95%;margin-left: 20px;">
                    <div class="card-body" style="margin-bottom: 20px;background: #19223a;margin-top: -10px;">
                        <div class="row align-items-center no-gutters">
                            <div class="col me-2">
                                <div class="text-uppercase text-info fw-bold text-xs mb-1"><span>COURSE PROGRESS</span></div>
                                <div class="row g-0 align-items-center">
                                    <div class="col-auto">
                                        <div class="text-dark fw-bold h5 mb-0 me-3"><span style="color: rgb(227,228,234);">50%</span></div>
                                    </div>
                                    <div class="col">
                    ...
                    <?php
                            ...
                            elseif ($_GET["sc"] === "Songwriting") {
                                $cid= 3;
                            }
                            elseif ($_GET["sc"] === "Guitar") {
                                 $cid= 2;
                            }
                            //echo "<script>alert($cid)</script>";
                        $lesson->getCompletedLessons($cid, $uid);
                        $lesson->getCurrentLesson($cid, $uid);
                        $lesson->getLockedLessons($cid, $uid, "Tenor");
                    ?>
