        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Choose Your Course</h3>
                    <div class="card shadow mb-5"></div>
                </div><!-- Start: Color Contact List --><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/boxicons@2.0.7/css/boxicons.min.css">

<div class="container">
    <form method="get" style="justify-content: center;" class="row row-cols-1 row-cols-lg-2 row-cols-xl-4">
        <div class="col">
            <div class="card radius-15 bg-primary">
                <div class="card-body text-center">
                    <div class="p-4 radius-15">
                        <img src="assets/img/singer.jpg" width="110" height="110" class="rounded-circle shadow p-1 bg-white" alt="">
                        <h5 class="mb-0 mt-5 text-white">Singing</h5>
                        <p></p>
                        <div class="d-grid"> <button name="submit" value="Singing" onclick="selectCourse(this)" style="color: white;" type="submit" class="btn btn-white radius-15">Learn</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col">
            <div class="card radius-15 bg-danger">
                <div class="card-body text-center">
                    <div class="p-4 radius-15">
                        <img src="assets/img/guitar.jpg" width="110" height="110" class="rounded-circle shadow p-1 bg-white" alt="">
                        <h5 class="mb-0 mt-5 text-white">Guitar</h5>
                        <p></p>
                        <div class="d-grid"> <button name="submit" value="Guitar" onclick="selectCourse(this)" style="color: white;" type="submit" class="btn btn-white radius-15">Learn</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col">
            <input type="hidden" name="SelectedCourse" id="sc">
            <div class="card radius-15 bg-warning">
                <div class="card-body text-center">
                    <div class="p-4 radius-15">
                        <img src="assets/img/book.png" width="110" height="110" class="rounded-circle shadow p-1 bg-white" alt="">
                        <h5 class="mb-0 mt-5 text-dark">Songwriting</h5>
                        <p></p>
                        <div class="d-grid"> <button name="submit" value="Songwriting" onclick="selectCourse(this)" style="color: white;" type="submit" class="btn btn-white radius-15">Learn</button>
                        </div>
                    </div>
                </div>
            </div>
 ...
 if (isset($_GET['submit']))
  {
    ...
    $submit = $_GET['submit'];
    echo "<script>window.open('lessons.php?sc=$submit','_self')</script>";
  }
?>