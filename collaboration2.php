        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h5 class="text-dark mb-4">Songwriting Collaboration</h5>
                    <br>
                    
                </div>
                
                
                    <div><a class="btn btn-outline-primary" role="button" href="collaboration.php">← Back</a><a class="btn btn-outline-primary float-end" role="button" href="writingpad.php?sid=<?php echo $_GET["sid"]; ?>">Next →</a></div>
                ...
                <div class="container-fluid">
                                        <div class="card shadow">
                                            <div class="card-header py-3">
                                                <h2 class="text-primary m-0 fw-bold">Add Collaborators From List</h2>
                                            </div>
                                            <div class="card-body">
                                                <div class="row">
                                                ...
                                                <div class="table-responsive table mt-2" id="dataTable-1" role="grid" aria-describedby="dataTable_info">
                                                    <table class="table my-0" id="dataTable">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $application->getAllStudents($_SESSION['user_id']);
                                                            ?>
  ...
  if (Input::exists()) 
  {
      ...
      if ($validation->passed()) 
      {
        ...
        try
        {
          ...
          if (isset($_GET["sid"])) {
            $_SESSION['cc_song_id'] = $_GET["sid"];
              # code...
          }
          $collabID=$db->getcollabID($_SESSION['cc_song_id'], $_SESSION["user_id"], date('y-m-d'));
          //echo'<script>alert("'.$collabID.'")</script>';
          $fields=array(
            'collabiD' => $collabID,
            'studentid' => Input::get('cmdAdd')
          );
          $db->insert('collabmembers', $fields);
          //$_SESSION['current_song_title'] = Input::get('Song_Title');
          
         
          echo '<script>toastr.success("Collaborator Added!")</script>';
        }
        catch(Exception $e)
        {
