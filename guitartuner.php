            ...
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    if ($_SESSION['user_type']==="Student") 
                    {
                        ...
                        <li class="nav-item"><a class="nav-link active" href="guitartuner.php"><i class="fas fa-guitar"></i>Guitar Tuner</a></li>
                    ...
                    <div class="card shadow mb-5">
                        <div>
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item" role="presentation"><a class="nav-link active" role="tab" data-bs-toggle="tab" href="#tab-1">Guitar Tuner Scale</a></li>
                                <li class="nav-item" role="presentation"><a class="nav-link" role="tab" data-bs-toggle="tab" href="#tab-2">Guitar Tuner Meter</a></li>
                            </ul>
                            <div class="tab-content">
                                <div class="tab-pane active" role="tabpanel" id="tab-1">
                                    <p><div style="width:100%; padding-bottom:56.25%; position:relative;">
<iframe src="https://guitar-tuner.appspot.com" allow="microphone *;" style="position:absolute; top:0px; left:0px; 
  ...
  <iframe src="guitartuner/index.html" allow="microphone *;" style="position:absolute; top:0px; left:0px; 
  width:100%; height:100%; border: none; overflow: hidden;"></iframe>
</div></div>
