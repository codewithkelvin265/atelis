<?php 
  ...
  elseif (isset($_SESSION['user_loggedin']) && $_SESSION['user_type']!== 'Instructor') {
    echo "<script>window.open('index.php','_self')</script>";
  }
?>
<?php 
  ...
  $lesson=new Lesson();
  $sub=$lesson->getASubmission($_GET["sid"]);
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Give Feedback</h3>
                    ...
                    <div class="row">
                        <div class="col-md-5 mb-4">
                            <div class="card border-white h-100">
                                <div class="card-body">
                                    ...
                                    <br>
                                    <h6 class="text-muted card-subtitle mb-2">Submitted By: <?php echo $sub["firstname"]." ".$sub["lastname"]; ?></h6>
                                    <br>
                                    <p class="card-text">Assignment Instruction: <?php echo $sub["assignment"]; ?></p>
                                    <br>
                                    <h4 class="card-title" style="margin-left: 1px;">Audio Submission</h4><audio src="assets/aud/as/<?php echo $sub["subfile"]; ?>" id="audb" controls="" style="margin-left: 0.1%;width: 100%;">
                                    </audio>
                                    ...
                                    <form>
                                        ...
                                        <button class="btn btn-primary" type="button" style="margin-top: 20px;text-align: right;">Show/Hide Lyrics Below<br></button>
                                    </form>
                        ...
                        <div class="col-md-7 mb-4">
                            <div class="card h-100"><a href="#"></a>
                                <h4 style="margin-right: 0px;margin-left: 20px;margin-top: 8px;">Grading and Feedback</h4>
                                <div class="row">
                                    <div class="col">
                                        <p style="margin-left: 3%;">Grade the student's performance form a scale of 1-10 and give a comment based on their performance.</p>
                                    </div>
                                </div>
                                <form action="" method="post" style="width: 90%;margin-left: 4%;"><label class="form-label">Grade:</label><input required="" min="1" max="10" maxlength="2" name="Grade" class="form-control" type="number"><label class="form-label">Feedback Comment:</label><textarea name="Comment" required="" class="form-control" style="height: 130px;"></textarea ><button class="btn btn-primary" type="Submit" style="margin-top: 20px;text-align: right;">Submit Feedback<br></button></form>
                            </div>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-md-7 mb-4" style="width: 100%;">
                            <div class="card h-100"><a href="#"></a>
                                <h4 style="margin-left: 2%;margin-top: 20px;text-align: center;">Song Lyrics</h4>
                                <h6 class="text-muted mb-2" style="margin-left: 2%;margin-top: 20px;text-align: center;">Subtitle</h6>
                                <p style="margin-left: 1%;margin-top: 20px;text-align: center;"><?php echo $sub["subcontent"]; ?>Nullam id dolor id nibh ultricies vehicula ut id elit. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus.</p>
                            </div>
                        </div>
                    </div>
                    <hr>
...
<?php
  ...
  if (Input::exists()) 
  {
        ...
        try
        {
            ...
            $db->updateLesson($sub["studentiD"], $sub["lessonid"], $fields);
            ...
            if ( $prog !== 10 || $prog !== 20) {
                $db->updateLesson($sub["studentiD"], $sub["lessonid"]+1, $fields);
            }
            echo '<script>toastr.success("Feedback Sent")</script>';
