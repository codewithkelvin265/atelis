            ...
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    if ($_SESSION['user_type']==="Student") 
                    {
                        ...
                        <li class="nav-item"><a class="nav-link active" href="collaboration.php"><i class="far fa-edit"></i><span>Songwriting Collaboration</span></a></li>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                        ...
                        <ul class="navbar-nav flex-nowrap ms-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="d-none d-lg-inline me-2 text-gray-600 small"><strong><?php echo $_SESSION["user_name"]; ?></strong></span><img class="border rounded-circle img-profile" src="assets/img/user.png"></a>
                                    <div class="dropdown-menu shadow dropdown-menu-end animated--grow-in"><a class="dropdown-item" href="profile.php"><i class="fas fa-user fa-sm fa-fw me-2 text-gray-400"></i>&nbsp;Profile</a><a class="dropdown-item" href="#"><i class="fas fa-cogs fa-sm fa-fw me-2 text-gray-400"></i>&nbsp;Dashboard</a>
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Songwriting Collaboration</h3>
                    <br>
                    <div class="card shadow mb-5">
                        <br>
                        <p class="text-dark text-center">Select Song You Want to Collaborate On or Create a New One</p>
                    </div>
                    <form style=""  action="" method="post">
                                                
                                                    
                                                        
                                                        <input value="" style="width: 62%;" class="form-control d-inline" type="text" id="username" placeholder="Enter Title Here" name="Song_Title">
                                                        <button class="btn btn-primary" type="submit">New Song</button>
                        ...
                        <div class="col-md-12">
                            ...
                            <div>
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item" role="presentation"><a class="nav-link active" role="tab" data-bs-toggle="tab" href="#tab-1">My Songs <span class="badge rounded-pill bg-primary">42</span></a></li>
                                    <li class="nav-item" role="presentation"><a class="nav-link" role="tab" data-bs-toggle="tab" href="#tab-2">Group Songs <span class="badge rounded-pill bg-primary">42</span></a></li>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" role="tabpanel" id="tab-1">
                                        ...
                                        <ul class="thread-list">
                                            <?php 
                                                $lesson->getSongsForCollab($_SESSION["user_id"]);
                                            ?>
                                        </ul>
                                    </div>
                                    <div class="tab-pane" role="tabpanel" id="tab-2">
                                        ...
                                        <ul class="thread-list">
                                            <?php 
                                                $lesson->getGroupSongs($_SESSION["user_id"]);
                                            ?>
                                        </ul>
                                    </div>
  ...
  if (Input::exists()) 
  {
      ...
      if ($validation->passed()) 
      {
        ...
        try
        {
          ...
          echo '<script>window.open("collaboration2.php?sid='.$songID.'","_self")</script>';
        }
        catch(Exception $e)
        {
