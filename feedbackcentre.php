            ...
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    if ($_SESSION['user_type']==="Student") 
                    {
                        ...
                        <li class="nav-item"><a class="nav-link active" href="feedbackcentre.php"><i class="la la-comment-o"></i><span>Check Feedback</span></a></li>
                        ';
                    }
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Feedback Centre</h3>
                    <div class="card shadow mb-5"></div>
                </div><!-- Start: Accordion with custom design. -->
                <div class="border rounded accordion mb-2" style="width: 98%;height: auto;margin-left: 1%;">
                    <?php $lesson->getFeedback($_SESSION["user_id"]); ?>
                    <!-- Start: Accordion Item -->
                
                    
                </div><!-- End: Accordion with custom design. -->
            </div>
